...
;
;
const HomeClient = (param)=>{
    let { initialData = {} } = param;
    _s();
    const { lang } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useLang$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLang"])();
...
_s(HomeClient, "MND8GK9T7IlEt/zomRjzWNlLRrQ=", false, function() {
    return [
...
//# sourceMappingURL=_a28d1a3f._.js.map